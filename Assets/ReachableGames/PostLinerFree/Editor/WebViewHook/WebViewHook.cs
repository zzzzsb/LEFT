	...
	namespace PostLinerFree
	{
		public class WebViewHook : ScriptableObject
		{
			...
			static WebViewHook()
			{
				...
				_AllowRightClickMenu = null;  // this crashes unity editor in all versions of 2019.3 for some reason
#else
			...
			public bool Hook(EditorWindow host)
			{
				...
				if (_AllowRightClickMenu!=null)
					Invoke(_AllowRightClickMenu, false);
